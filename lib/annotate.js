...
exports.annotate_with_suggestion = exports.annotate = exports.annotate_and_get_html_with_spans = void 0;
 ...
 * @param annotations
 */
function fixAnnotationsIdx(annotations) {
    var _a;
    let startIndex = -1;
    if (annotations.length > 0) {
        const ann = annotations[0];
        startIndex = (_a = ann.idx) !== null && _a !== void 0 ? _a : -1;
    }
    if (startIndex >= 0) {
        let fixed = true;
...
function _getSpans(annotations) {
    ...
    _.each(annotations, (annotation, aidx) => {
        var _a;
        const index = (_a = annotation.idx) !== null && _a !== void 0 ? _a : aidx;
...
function _injectAnnotations(html, spans, spanClasses, getSuggestions) {
    let pos = 0;
    let wSpans = spans;
 ...
 */
function annotate_and_get_html_with_spans(html, annotations) {
...
exports.annotate_and_get_html_with_spans = annotate_and_get_html_with_spans;
/**
 * Добавляет в `html` аннотации `annotations` в виде span-ов со специфическими стилями для последующей визуализации отчёта.
 ...
 */
function annotate_with_suggestion(html, annotations, splitSuggestion) {
    let spans = _getSpans(annotations.annotations);
    spans = _splitSpansEx(spans);
    ...
    function getSuggestion(annotationId, start, end) {
        var _a;
        const key = `${annotationId}-${start}-${end}`;
        return (_a = suggestionMap.get(key)) !== null && _a !== void 0 ? _a : [];
    }
    return _injectAnnotations(html, spans, _spanClassesVisual, getSuggestion);
}
exports.annotate_with_suggestion = annotate_with_suggestion;
